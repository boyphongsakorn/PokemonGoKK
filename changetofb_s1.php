...
แก้ไขข้อมูลแล้ว
<br>
ลิงค์รูปภาพ:<?php echo $user;?><br>ชื่อ:<?php echo $user_profile[name];?><br><a href="index.php">กลับไปหน้าแรก</a>
<?php
$sqlquery = "UPDATE $table SET image = '$user',imageurl = ' ' WHERE iduser = '$user'";
